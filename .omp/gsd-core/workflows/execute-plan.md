...
@/home/bgshi/Development/python/correlia/.omp/gsd-core/references/git-integration.md
</required_reading>
...
If previous SUMMARY has unresolved "Issues Encountered" or "Next Phase Readiness" blockers: Ask(header="Previous Issues", options: "Proceed anyway" | "Address first" | "Review previous").
</step>
...
See `/home/bgshi/Development/python/correlia/.omp/gsd-core/references/tdd.md` for structure.
</tdd_plan_execution>
...
See /home/bgshi/Development/python/correlia/.omp/gsd-core/references/checkpoints.md for details.
</step>
...
If `NODE_REPAIR` is `true`: invoke `@./.omp/gsd-core/workflows/node-repair.md` with:
...
If user_setup exists: create `{phase}-USER-SETUP.md` using template `/home/bgshi/Development/python/correlia/.omp/gsd-core/templates/user-setup.md`. Per service: env vars table, account setup checklist, dashboard config, local dev notes, verification commands. Status "Incomplete". Set `USER_SETUP_CREATED=true`. If empty/missing: skip.
</step>
...
Create `{phase}-{plan}-SUMMARY.md` at `.planning/phases/XX-name/`. Use `/home/bgshi/Development/python/correlia/.omp/gsd-core/templates/summary.md`.
