...
<answer_validation>
**IMPORTANT: Answer validation** — After every Ask call, check if the response
...
When text mode is active, do not use Ask at all. Present every question as a
...
**If matches found:** Present matched todos, use Ask (multiSelect) to fold relevant ones into scope.
