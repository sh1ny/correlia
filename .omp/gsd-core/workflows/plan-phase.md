...
**Project instructions:** Read AGENTS.md or ./.omp/AGENTS.md if either exists — follow project-specific guidelines
...
**Project instructions:** Read AGENTS.md or ./.omp/AGENTS.md if either exists — verify plans honor project guidelines
