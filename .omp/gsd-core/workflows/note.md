...
Runs inline — no Task, no Ask, no Bash.
</purpose>
...
- **Global scope**: `/home/bgshi/Development/python/correlia/.omp/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/bgshi/Development/python/correlia/.omp/notes/`)
...
2. Glob `/home/bgshi/Development/python/correlia/.omp/notes/*.md` (if directory exists) — global notes
...
Global (/home/bgshi/Development/python/correlia/.omp/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/bgshi/Development/python/correlia/.omp/notes/` — works in any directory
