...
```bash
if [ "$RUNTIME" = "codex" ]; then INSTRUCTION_FILE="AGENTS.md"; else INSTRUCTION_FILE=".omp/AGENTS.md"; fi
```
...
SPIKE_SKILL=$(ls ./.omp/skills/spike-findings-*/SKILL.md 2>/dev/null | head -1 || true)

# Check for sketch findings skill (project-local)
SKETCH_SKILL=$(ls ./.omp/skills/sketch-findings-*/SKILL.md 2>/dev/null | head -1 || true)
...
Based on what they said, ask follow-up questions that dig into their response. Use Ask with options that probe what they mentioned — interpretations, clarifications, concrete examples.
...
When you could write a clear PROJECT.md, use Ask:
...
**Otherwise** (Claude runtime with Ask): use a two-block split
...
Use template: /home/bgshi/Development/python/correlia/.omp/gsd-core/templates/research-project/STACK.md
</output>
...
Use template: /home/bgshi/Development/python/correlia/.omp/gsd-core/templates/research-project/FEATURES.md
</output>
...
Use template: /home/bgshi/Development/python/correlia/.omp/gsd-core/templates/research-project/ARCHITECTURE.md
</output>
...
Use template: /home/bgshi/Development/python/correlia/.omp/gsd-core/templates/research-project/PITFALLS.md
</output>
...
Use template: /home/bgshi/Development/python/correlia/.omp/gsd-core/templates/research-project/SUMMARY.md
...
Ask the user how they want to structure the project. Use `Ask` with two options:
...
- `.planning/ROADMAP.md`
- `.planning/STATE.md`
- `$INSTRUCTION_FILE` (`AGENTS.md` for Codex, `.omp/AGENTS.md` for all other runtimes)
...
- [ ] `$INSTRUCTION_FILE` generated with GSD workflow guidance (AGENTS.md for Codex, `.omp/AGENTS.md` otherwise; an existing hand-crafted file without GSD markers is left untouched unless `--force`)
