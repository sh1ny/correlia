...
Plan-driven development for solo agentic work with OMP. GSD Core turns a vague idea into a hierarchical plan, then executes it phase by phase with state tracking and atomic commits.
