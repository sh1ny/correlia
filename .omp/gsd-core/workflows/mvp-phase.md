...
<required_reading>
@.omp/gsd-core/references/user-story-template.md
@.omp/gsd-core/references/spidr-splitting.md
@.omp/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@.omp/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `Ask` calls. Each is free-text. After all three, assemble into the canonical sentence per `@.omp/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@.omp/gsd-core/references/spidr-splitting.md`. Briefly:
