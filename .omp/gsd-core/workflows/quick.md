...
For each selected area, ask 1-2 focused questions via Ask:
...
- AGENTS.md or ./.omp/AGENTS.md (if exists — project-specific guidelines)
...
- AGENTS.md or ./.omp/AGENTS.md (if exists — follow project-specific guidelines)
...
- .planning/STATE.md (Project state)
- AGENTS.md or ./.omp/AGENTS.md (Project instructions, if exists)
- .omp/skills/ or .agents/skills/ (Project skills, if either exists — list skills, read SKILL.md for each, follow relevant rules during implementation)
</files_to_read>
