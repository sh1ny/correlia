...
Ask(header="Archive Phases", question="Archive phase directories to milestones/?", options: "Yes — move to milestones/v[X.Y]-phases/" | "Skip — keep phases in place")
...
**If doesn't exist:** Create from template at `/home/bgshi/Development/python/correlia/.omp/gsd-core/templates/retrospective.md`.
...
Ask with options: Squash merge (Recommended), Merge with history, Delete without merging, Keep branches.
