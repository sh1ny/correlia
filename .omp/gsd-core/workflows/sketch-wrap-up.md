...
UI implementation. Reads from `.planning/sketches/`, writes skill to `./.omp/skills/sketch-findings-[project]/`
...
3. Check if `./.omp/skills/sketch-findings-*/SKILL.md` exists for this project
...
Derive from the project directory name: `./.omp/skills/sketch-findings-[project-dir-name]/`
...
**Design areas:** [list]
**Skill output:** `./.omp/skills/sketch-findings-[project]/`
...
**Design areas:** {list}
**Skill:** `./.omp/skills/sketch-findings-[project]/`
...
- [ ] Sketch-findings skill exists at `./.omp/skills/` with SKILL.md, references/, sources/
