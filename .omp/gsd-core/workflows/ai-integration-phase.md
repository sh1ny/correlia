...
<required_reading>
@.omp/gsd-core/references/ai-frameworks.md
@.omp/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read .omp/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp ".omp/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read .omp/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read .omp/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read .omp/agents/gsd-eval-planner.md for instructions.
