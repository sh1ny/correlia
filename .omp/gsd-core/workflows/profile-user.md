...
Key references:
- @.omp/gsd-core/references/ui-brand.md (display patterns)
- @.omp/agents/gsd-user-profiler.md (profiler agent definition)
- @.omp/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH=".omp/gsd-core/USER-PROFILE.md"
...
```bash
cp ".omp/gsd-core/USER-PROFILE.md" ".omp/USER-PROFILE.backup.md"
```
...
✓ Stores profile at .omp/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `.omp/gsd-core/references/user-profiling.md`
...
Reference: @.omp/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to .omp/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to .omp/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at .omp/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at .omp/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to .omp/AGENTS.md"
...
```bash
BACKUP_PATH=".omp/USER-PROFILE.backup.md"
```
...
Your profile:    .omp/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   .omp/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       AGENTS.md
  ✓ Global AGENTS.md        .omp/AGENTS.md
```
