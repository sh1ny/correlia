...
Key references:
- @/home/bgshi/Development/python/correlia/.omp/gsd-core/references/ui-brand.md (display patterns)
- @/home/bgshi/Development/python/correlia/.omp/agents/gsd-user-profiler.md (profiler agent definition)
- @/home/bgshi/Development/python/correlia/.omp/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/home/bgshi/Development/python/correlia/.omp/gsd-core/USER-PROFILE.md"
...
```bash
cp "/home/bgshi/Development/python/correlia/.omp/gsd-core/USER-PROFILE.md" "/home/bgshi/Development/python/correlia/.omp/USER-PROFILE.backup.md"
```
...
Your recent OMP sessions, looking for patterns in these
...
✓ Stores profile at /home/bgshi/Development/python/correlia/.omp/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `/home/bgshi/Development/python/correlia/.omp/gsd-core/references/user-profiling.md`
...
Reference: @/home/bgshi/Development/python/correlia/.omp/gsd-core/references/user-profiling.md
...
**Present each question to the user via Ask:**
...
Display: "✓ Profile written to /home/bgshi/Development/python/correlia/.omp/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to /home/bgshi/Development/python/correlia/.omp/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /home/bgshi/Development/python/correlia/.omp/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /home/bgshi/Development/python/correlia/.omp/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /home/bgshi/Development/python/correlia/.omp/AGENTS.md"

**Error handling:** If any `gsd-tools.cjs query` or gsd-tools.cjs call fails, display the error message and use Ask to offer "Retry" or "Skip this artifact". On retry, re-run the command. On skip, continue to next artifact.
...
```bash
BACKUP_PATH="/home/bgshi/Development/python/correlia/.omp/USER-PROFILE.backup.md"
```
...
Your profile:    /home/bgshi/Development/python/correlia/.omp/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /home/bgshi/Development/python/correlia/.omp/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       <resolved claude_md_path, default ./.omp/AGENTS.md>
  ✓ Global AGENTS.md        /home/bgshi/Development/python/correlia/.omp/AGENTS.md
```

(Show the `claude_md_path` actually returned by the command — it defaults to `./.omp/AGENTS.md` but may be overridden by config or `--output`.)
