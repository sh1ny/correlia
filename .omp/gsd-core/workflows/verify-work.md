...
<template>
@/home/bgshi/Development/python/correlia/.omp/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/home/bgshi/Development/python/correlia/.omp/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Wait for user response (plain text, no Ask).
</step>
...
Read and follow `/home/bgshi/Development/python/correlia/.omp/gsd-core/workflows/transition.md`.
...
- Follow @/home/bgshi/Development/python/correlia/.omp/gsd-core/workflows/diagnose-issues.md
