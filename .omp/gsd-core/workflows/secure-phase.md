...
Call Ask with threat table and options:
...
```
Agent(
  prompt="Read /home/bgshi/Development/python/correlia/.omp/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/bgshi/Development/python/correlia/.omp/gsd-core/templates/SECURITY.md`
