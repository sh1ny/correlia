...
## Using OMP with Non-Anthropic Providers (OpenRouter, Local)

If you're using OMP with OpenRouter, a local model, or any non-Anthropic provider, set the `inherit` profile to prevent GSD from calling Anthropic models for subagents:
