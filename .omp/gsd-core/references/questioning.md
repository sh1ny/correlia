...
Use Ask to help users think by presenting concrete options to react to.
...
**When the user wants to explain freely, STOP using Ask.**
...
1. **Ask your follow-up as plain text** — NOT via Ask
2. **Wait for them to type at the normal prompt**
3. **Resume Ask** only after processing their freeform response
...
**Wrong:** User says "let me describe it" → Ask("What feature?", ["Feature A", "Feature B", "Describe in detail"])
