...
**commands/gsd/**
- Purpose: Slash command definitions for OMP
...
- `AGENTS.md` - Instructions for OMP when working in this repo
...
- Usage: Reference from command with `@/home/bgshi/Development/python/correlia/.omp/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /home/bgshi/Development/python/correlia/.omp/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/bgshi/Development/python/correlia/.omp/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
