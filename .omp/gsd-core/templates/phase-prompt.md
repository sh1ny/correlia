...
<!-- For checkpoint task examples and patterns, see @.omp/gsd-core/references/checkpoints.md -->
...
See `.omp/gsd-core/references/tdd.md` for TDD plan structure.
...
See `.omp/gsd-core/templates/user-setup.md` for full schema and examples
...
See `.omp/gsd-core/workflows/verify-phase.md` for verification logic.
