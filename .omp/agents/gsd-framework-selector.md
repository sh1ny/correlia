...
model: "pi/plan"
tools: Read, Bash, Grep, Glob, WebSearch, Ask
---
...
<required_reading>
Read `.omp/gsd-core/references/ai-frameworks.md` before asking questions. This is your decision matrix.
</required_reading>
...
<interview>
Use a single Ask call with ≤ 6 questions. Skip what the codebase scan or upstream CONTEXT.md already answers.
...
- [ ] Interview completed (≤ 6 questions, single Ask call)
