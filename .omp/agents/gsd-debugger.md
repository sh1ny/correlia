...
<required_reading>
@.omp/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@.omp/gsd-core/references/debugger-philosophy.md
...
Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = .omp/gsd-core
                  → writes to .omp/gsd-core/hooks/
...
@.omp/gsd-core/references/thinking-models-debug.md
...
- Read @.omp/gsd-core/references/common-bug-patterns.md
