...
**Project skills:** Check `.omp/skills/` or `.agents/skills/` directory if either exists:
...
Use template from `.omp/gsd-core/templates/UI-SPEC.md`.
...
Read template: `.omp/gsd-core/templates/UI-SPEC.md`
