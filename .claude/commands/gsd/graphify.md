...
**CJS-only (graphify):** `graphify` subcommands are not registered on `gsd-tools query`. Use `node /home/bgshi/Development/python/correlia/.claude/gsd-core/bin/gsd-tools.cjs graphify …` as documented in this command and in `docs/CLI-TOOLS.md`. Other tooling may still use `gsd-tools query` where a handler exists.
...
Knowledge graph is disabled. To activate:
  ...
  node /home/bgshi/Development/python/correlia/.claude/gsd-core/bin/gsd-tools.cjs config-set graphify.enabled true
...
```bash
node /home/bgshi/Development/python/correlia/.claude/gsd-core/bin/gsd-tools.cjs graphify query <term>
```
...
```bash
node /home/bgshi/Development/python/correlia/.claude/gsd-core/bin/gsd-tools.cjs graphify diff
```
...
```bash
node "/home/bgshi/Development/python/correlia/.claude/gsd-core/bin/gsd-tools.cjs" graphify build
```
...
graphify update . \
  ...
  && node "/home/bgshi/Development/python/correlia/.claude/gsd-core/bin/gsd-tools.cjs" graphify build snapshot \
  && node "/home/bgshi/Development/python/correlia/.claude/gsd-core/bin/gsd-tools.cjs" graphify status
```
