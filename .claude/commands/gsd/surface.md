...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/bgshi/Development/python/correlia/.claude/.gsd-surface.json`
(sibling to `/home/bgshi/Development/python/correlia/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/bgshi/Development/python/correlia/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/bgshi/Development/python/correlia/.claude/skills`).
...
`/home/bgshi/Development/python/correlia/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/bgshi/Development/python/correlia/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/bgshi/Development/python/correlia/.claude/.gsd-surface.json`
Install profile marker: `/home/bgshi/Development/python/correlia/.claude/.gsd-profile`
Skill dirs: `/home/bgshi/Development/python/correlia/.claude/skills/gsd-*/`
Engine module: `/home/bgshi/Development/python/correlia/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/bgshi/Development/python/correlia/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
