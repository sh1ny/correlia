...
```bash
INIT=$(node "/home/bgshi/Development/python/correlia/.claude/gsd-core/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/bgshi/Development/python/correlia/.claude/gsd-core/bin/gsd-tools.cjs" commit \
