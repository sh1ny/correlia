...
```bash
INIT=$(node "/home/bgshi/Development/python/correlia/.claude/gsd-core/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/bgshi/Development/python/correlia/.claude/gsd-core/templates/spec.md.
