...
Reference full template: `/home/bgshi/Development/python/correlia/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/bgshi/Development/python/correlia/.claude/gsd-core/templates/state.md`.
