...
@/home/bgshi/Development/python/correlia/.claude/gsd-core/references/thinking-models-research.md
...
```bash
node "/home/bgshi/Development/python/correlia/.claude/gsd-core/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
