...
<required_reading>
Read `/home/bgshi/Development/python/correlia/.claude/gsd-core/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
