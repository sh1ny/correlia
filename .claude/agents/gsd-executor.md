...
@/home/bgshi/Development/python/correlia/.claude/gsd-core/references/thinking-models-execution.md

**iOS app scaffolding:** If this plan creates an iOS app target, follow ios-scaffold guidance:
@/home/bgshi/Development/python/correlia/.claude/gsd-core/references/ios-scaffold.md
...
@/home/bgshi/Development/python/correlia/.claude/gsd-core/references/executor-examples.md
</deviation_rules>
...
**See @/home/bgshi/Development/python/correlia/.claude/gsd-core/references/checkpoints.md**
...
**When the orchestrator passes both `MVP_MODE=true` and `TDD_MODE=true`:** Before running the implementation step of any task with `tdd="true"`, run the runtime gate from `@/home/bgshi/Development/python/correlia/.claude/gsd-core/references/execute-mvp-tdd.md`. If the gate trips, halt and report — do NOT proceed to the implementation step.
...
**Use template:** @/home/bgshi/Development/python/correlia/.claude/gsd-core/templates/summary.md
