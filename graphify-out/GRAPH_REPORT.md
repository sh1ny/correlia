# Graph Report - correlia  (2026-06-08)

## Corpus Check
- 468 files · ~455,390 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4240 nodes · 4254 edges · 536 communities (490 shown, 46 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 49 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `57333421`
...
2. `Settings` - 40 edges
3. `agents` - 34 edges
4. `model_overrides` - 34 edges
5. `IncidentUpsertInput` - 34 edges
6. `workflow` - 33 edges
7. `workflow` - 30 edges
8. `Pattern Assignments` - 30 edges
9. `upsert_open_incident()` - 22 edges
10. `Phase 1: Foundations, Contracts, and Database Invariant - Research` - 20 edges

## Surprising Connections (you probably didn't know these)
- `AsyncClient` --uses--> `Settings`  [INFERRED]
  tests/test_health.py → app/config/settings.py
- `FailingSession` --uses--> `Settings`  [INFERRED]
  tests/test_health.py → app/config/settings.py
- `RuntimeError` --uses--> `Settings`  [INFERRED]
  tests/test_health.py → app/config/settings.py
- `SuccessfulSession` --uses--> `Settings`  [INFERRED]
  tests/test_health.py → app/config/settings.py
- `FailingSession` --uses--> `Settings`  [INFERRED]
  tests/test_settings.py → app/config/settings.py

## Import Cycles
- 1-file cycle: `app/main.py -> app/main.py`
- 1-file cycle: `app/domain/events.py -> app/domain/events.py`
- 1-file cycle: `app/domain/incidents.py -> app/domain/incidents.py`

## Communities (536 total, 46 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.00
Nodes (497): files, agents/gsd-advisor-researcher.md, agents/gsd-ai-researcher.md, agents/gsd-assumptions-analyzer.md, agents/gsd-code-fixer.md, agents/gsd-code-reviewer.md, agents/gsd-codebase-mapper.md, agents/gsd-debug-session-manager.md (+489 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (65): Any, datetime, datetime, AsyncSession, BaseModel, EventType, max_severity(), NormalizedEvent (+57 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (68): ALL_READ_PATTERNS, ARGUMENT_TAKING_FLAGS, BOOLEAN_FLAGS, buildUpdateBannerOutput(), communityEnabled(), configDirFromExtension(), configWatchers, contextWarningState (+60 more)
...
Cohesion: 0.04
Nodes (44): Acknowledgement Metadata, Not Status, `alembic.ini` (config, config), `app/api/deps.py` (utility, request-response), `app/api/__init__.py` (config, import-boundary), `app/api/routers/health.py` (route, request-response), `app/api/routers/__init__.py` (config, import-boundary), `app/config/__init__.py` (config, import-boundary), `app/config/settings.py` (config, config) (+36 more)
...
Cohesion: 0.06
Nodes (34): model_overrides, gsd-advisor-researcher, gsd-ai-researcher, gsd-assumptions-analyzer, gsd-code-fixer, gsd-code-reviewer, gsd-codebase-mapper, gsd-debug-session-manager (+26 more)
...
Cohesion: 0.07
Nodes (30): workflow, ai_integration_phase, auto_advance, _auto_chain_active, auto_prune_state, code_review, code_review_command, code_review_depth (+22 more)
...
Cohesion: 0.07
Nodes (27): Alternatives Considered, API / FastAPI, Architecture, Confidence Assessment, Constraints, Conventions, Core Technologies, Developer Profile (+19 more)

### Community 20 - "Community 20"
Cohesion: 0.07
Nodes (27): 1. Project Overview, 2. Technology Stack, 3.1 The "Normalized Event" Model, 3.2 Database Schema (PostgreSQL), 3.3 Topology Enrichment Configuration (`topology.yaml`), 3. Data Architecture, 4.1 Rule Configuration (`rules.yaml`), 4. The "Brain": Rule Engine (+19 more)
...
Cohesion: 0.07
Nodes (26): Acknowledgement Semantics Fight Automatic Recovery, `affected_hosts` Grows Without Bound or Loses Uniqueness, Critical Pitfalls, Expiration Closes Incidents Still Receiving Late Events, Integration Gotchas, “Looks Done But Isn’t” Checklist, Moderate Pitfalls, Partial Unique Index Predicate Drift (+18 more)
...
Cohesion: 0.15
Nodes (13): create_app(), async_sessionmaker, AsyncSession, Settings, AsyncClient, FailingSession, get_client(), RuntimeError (+5 more)

### Community 29 - "Community 29"
Cohesion: 0.09
Nodes (21): agent_skills, brave_search, claude_md_path, commit_docs, exa_search, firecrawl, granularity, graphify (+13 more)
...
Cohesion: 0.10
Nodes (20): Alternatives Considered, API / FastAPI, Confidence Assessment, Core Technologies, Installation, Migrations, PostgreSQL / SQLAlchemy, Prescriptive Implementation Choices (+12 more)
...
Cohesion: 0.10
Nodes (19): Additional Inputs, Advanced Operations, Distributed Execution, Domain Contracts, Foundation, Icinga2 Ingress, Incident Lifecycle, Operability (+11 more)
...
Cohesion: 0.12
Nodes (7): FailingSession, RuntimeError, RecordingSession, test_check_database_ready_executes_fixed_select_one(), test_check_database_ready_raises_original_connectivity_failure(), test_valid_database_url_and_defaults(), TextClause

### Community 45 - "Community 45"
Cohesion: 0.11
Nodes (17): Active Incident Lifecycle, Canonical References, Claude's Discretion, Deferred Ideas, Domain Contract Strictness, Established Patterns, Existing Code Insights, Implementation Decisions (+9 more)

### Community 46 - "Community 46"
Cohesion: 0.11
Nodes (17): Critical Issues, IN-01: Deprecated `Union` import used in Python 3.14 codebase, IN-02: Missing return type annotation on public builder function, Info, Phase 01: Code Review Report, Summary, Warnings, WR-01: `subprocess.run(check=True)` renders manual returncode check unreachable (+9 more)

### Community 47 - "Community 47"
Cohesion: 0.20
Nodes (15): get_app_settings(), get_sessionmaker(), async_sessionmaker, AsyncSession, Settings, async_sessionmaker, AsyncSession, Settings (+7 more)
...
Cohesion: 0.12
Nodes (15): Add After Validation (v1.x), Anti-Features (Commonly Requested, Often Problematic), Competitor / Reference Feature Analysis, Dependency Notes, Differentiators (Competitive Advantage), Feature Dependencies, Feature Landscape, Feature Prioritization Matrix (+7 more)
...
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Deviations from Plan, Files Created/Modified, Issues Encountered, Known Stubs, Next Phase Readiness, Performance (+6 more)
...
Cohesion: 0.13
Nodes (14): Architectural Responsibility Map, Assumptions Log, Don't Hand-Roll, Environment Availability, Locked Decisions, Metadata, Open Questions (RESOLVED), Package Legitimacy Audit (+6 more)

### Community 62 - "Community 62"
Cohesion: 0.13
Nodes (14): [1.2.0](https://www.npmjs.com/package/@opengsd/gsd-core/v/1.2.0) - 2026-05-31, [1.3.0](https://www.npmjs.com/package/@opengsd/gsd-core/v/1.3.0) - 2026-06-04, [1.3.1](https://www.npmjs.com/package/@opengsd/gsd-core/v/1.3.1) - 2026-06-04, Added, Added, Added, Changed, Changelog (+6 more)
...
Cohesion: 0.15
Nodes (12): Acknowledgement model, Active Incident Lifecycle, Claude's Discretion, Database uniqueness, Deferred Ideas, Domain Contract Strictness, Identity, timestamps, severity, affected entities, Incident Debug Metadata (+4 more)
...
Cohesion: 0.23
Nodes (9): get_settings(), Connection, DeclarativeBase, do_run_migrations(), get_database_url(), run_migrations_offline(), run_migrations_online(), Base (+1 more)
...
Cohesion: 0.17
Nodes (11): Active, Constraints, Context, Core Value, Correlia, Evolution, Key Decisions, Out of Scope (+3 more)

### Community 83 - "Community 83"
Cohesion: 0.17
Nodes (11): Accumulated Context, Accumulated Context, Blockers/Concerns, Current Position, Decisions, Deferred Items, Performance Metrics, Project Reference (+3 more)
...
Cohesion: 0.31
Nodes (9): lifespan(), async_sessionmaker, AsyncSession, Settings, AsyncEngine, FastAPI, check_database_ready(), create_engine() (+1 more)

### Community 99 - "Community 99"
Cohesion: 0.18
Nodes (10): Overview, Phase 1: Foundations, Contracts, and Database Invariant, Phase 2: Icinga2 Ingress, Topology, and Rule Decisions, Phase 3: Problem Aggregation and Notification Dispatch, Phase 4: Lifecycle, Operator APIs, and Operability, Phase Details, Phases, Progress (+2 more)
...
Cohesion: 0.20
Nodes (9): Architecture Research, Confidence and Research Notes, First Bottlenecks to Watch, Recommendation, Recommended Project Structure, Scaling Considerations, Sources, Structure Rationale (+1 more)
...
Cohesion: 0.33
Nodes (8): Testcontainers-backed PostgreSQL migration and schema invariant tests., _run_alembic_upgrade(), test_check_constraints(), test_duplicate_open_row_blocked(), test_incidents_columns_and_types(), test_migration_creates_incidents_table(), test_partial_unique_index(), test_resolved_does_not_block_new_open()
...
Cohesion: 0.22
Nodes (8): Accepted Risks Log, Phase 01 — Security, Security Audit 2026-06-08, Security Audit Trail, Sign-Off, Summary Threat Flags, Threat Register, Trust Boundaries
...
Cohesion: 0.25
Nodes (7): Answer, Implementation guidance, Open questions, Quick Research: Python requirement target, Repo touchpoints likely requiring updates, Sources, Why 3.14, not 3.13 or 3.15?

### Community 143 - "Community 143"
Cohesion: 0.25
Nodes (7): Commit, Files Changed, Quick Task 260608-kd5 Summary, Result, Runtime Metadata Check, Status, Verification
...
Cohesion: 0.29
Nodes (7): Active Incident Lifecycle, Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Domain Contract Strictness, Implementation Decisions, Incident Debug Metadata, Service Bootstrap Surface

### Community 161 - "Community 161"
Cohesion: 0.29
Nodes (7): Anti-Patterns to Avoid, Architecture Patterns, Pattern 1: Strict Pydantic Contract at Boundaries, Pattern 2: PostgreSQL Owns the Active-Incident Invariant, Pattern 3: Alembic Migration Is the Schema Source of Truth, Recommended Project Structure, System Architecture Diagram

### Community 162 - "Community 162"
Cohesion: 0.29
Nodes (6): Architectural Decisions, Capability Proven End-to-End, Out of Scope (Deferred to Later Slices), Stack Touched in Phase 1, Subsequent Slice Plan, Walking Skeleton — Correlia
...
Cohesion: 0.29
Nodes (7): Anti-Pattern 1: Source Payloads Leaking Past Input Plugins, Anti-Pattern 2: SELECT-Then-INSERT Incident Aggregation, Anti-Pattern 3: Treating `OK` as a Low-Severity Problem, Anti-Pattern 4: In-Memory Incident State, Anti-Pattern 5: Direct Background Task Calls from Business Logic, Anti-Pattern 6: Metrics with Host/Fingerprint Labels, Anti-Patterns to Avoid

### Community 175 - "Community 175"
Cohesion: 0.29
Nodes (7): Core Patterns to Follow, Pattern 1: Ports and Adapters for Plugin Boundaries, Pattern 2: Pipeline Orchestrator with Pure Decisions Before Writes, Pattern 3: Database-Enforced Incident Singularity, Pattern 4: Typed YAML Configuration at the Edge, Pattern 5: Lifespan-Owned Background Work, Pattern 6: Observability as Domain Events, Not Just HTTP Logs
...
Cohesion: 0.29
Nodes (7): agents, gsd-nyquist-auditor, balanced, budget, golden, phaseType, routingTier
...
Cohesion: 0.33
Nodes (6): Alembic Migration Snippet for Active Incident Uniqueness, Code Examples, FastAPI App Factory with Health/Readiness, Settings Model, SQLAlchemy PostgreSQL Partial-Index Upsert, Strict Domain Model with Timezone and Tag Validators

### Community 190 - "Community 190"
Cohesion: 0.33
Nodes (6): Common Pitfalls, Pitfall 1: Partial Index Predicate Drift, Pitfall 2: Acknowledgement Modeled as Status, Pitfall 3: Pydantic Defaults Still Coerce Unexpectedly, Pitfall 4: Readiness Equals Liveness, Pitfall 5: JSONB Metadata Becomes Raw Payload Storage
...
Cohesion: 0.33
Nodes (5): Activation, Effect, Empty-answer handling, Question rendering, --text mode — plain-text overlay (no Ask)

### Community 196 - "Community 196"
Cohesion: 0.33
Nodes (5): name, omp, extensions, private, type
...
Cohesion: 0.33
Nodes (6): effort, default, routing_tier_defaults, heavy, light, standard
...
Cohesion: 0.40
Nodes (5): API Read/Mutation Flow, Data Flow, Expiration Flow, Problem Event Flow, Recovery Event Flow
...
Cohesion: 0.50
Nodes (4): Incident Columns, PostgreSQL Persistence Design, Tables, Transaction Boundary

### Community 279 - "Community 279"
Cohesion: 0.50
Nodes (4): Metrics, Observability Architecture, Structured Logs, Tracing
...
Cohesion: 0.67
Nodes (3): API Response Principle, Recommended Routers, REST API Boundaries

### Community 303 - "Community 303"
Cohesion: 0.67
Nodes (3): Build Order and Dependency Implications, Dependency Graph, Suggested Build Order
...
Cohesion: 0.67
Nodes (3): Important Design Adjustment, Incident State Model, Recommended Status Transitions

### Community 307 - "Community 307"
Cohesion: 0.67
Nodes (3): Matching Semantics, Rule Engine Architecture, Rule Evaluation

### Community 308 - "Community 308"
Cohesion: 0.67
Nodes (3): Output Dispatch Boundary, Task Runner and Output Dispatch, Task Runner Boundary
...
## Knowledge Gaps
- **3018 isolated node(s):** `fs`, `os`, `path`, `{ spawn, spawnSync }`, `PROMPT_INJECTION_PATTERNS` (+3013 more)
...
- **Why does `files` connect `Community 0` to `Community 276`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `agents` connect `Community 177` to `Community 151`, `Community 207`, `Community 208`, `Community 209`, `Community 210`, `Community 211`, `Community 212`, `Community 213`, `Community 214`, `Community 215`, `Community 216`, `Community 217`, `Community 218`, `Community 219`, `Community 220`, `Community 221`, `Community 222`, `Community 223`, `Community 224`, `Community 225`, `Community 226`, `Community 227`, `Community 228`, `Community 229`, `Community 230`, `Community 231`, `Community 232`, `Community 233`, `Community 234`, `Community 235`, `Community 236`, `Community 237`, `Community 238`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `runtimeTierDefaults` connect `Community 36` to `Community 282`, `Community 178`, `Community 21`, `Community 151`, `Community 280`, `Community 281`, `Community 26`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Are the 26 inferred relationships involving `Settings` (e.g. with `async_sessionmaker` and `AsyncSession`) actually correct?**
  _`Settings` has 26 INFERRED edges - model-reasoned connections that need verification._
- **Are the 4 inferred relationships involving `IncidentUpsertInput` (e.g. with `Severity` and `DecisionContext`) actually correct?**
  _`IncidentUpsertInput` has 4 INFERRED edges - model-reasoned connections that need verification._
